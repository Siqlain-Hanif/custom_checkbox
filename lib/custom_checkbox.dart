...
class _CustomCheckboxState extends State<CustomCheckbox>
  ...
  Widget build(BuildContext context) {
    ...
    final asize = Size(size.height - 10, size.width - 10);
    ...
    //   onShowHoverHighlight: ((value) => debugPrint("Hovered: $value")),
    //   onShowFocusHighlight: (((value) => debugPrint("Focus: $value"))),
    //   child:
    // );
  }
  ...
  Widget? get getEffectiveIconWidgetStateWidget {
    ...
    if (value == true) {
      effectiveIconWidget = const Icon(Icons.check);
    } else if (value == false) {
